...
import { Search, Barcode, Pill, Sparkles, X, Plus, Minus, Trash2, User, DollarSign, CreditCard, Printer } from 'lucide-react';
    ...
    <div className="h-[calc(100vh-7rem)]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 h-full">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 p-4 flex flex-col">
          ...
          {/* Tabs */}
          <Tabs.Root value={activeTab} onValueChange={(value: any) => setActiveTab(value)} className="flex-1 flex flex-col">
