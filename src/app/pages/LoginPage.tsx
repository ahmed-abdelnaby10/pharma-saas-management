      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
          ...
          <div className="flex items-center justify-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-2xl font-semibold text-gray-900">PharmaSaaS</h1>
          ...
          <div className="text-center mb-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-1">{t('welcomeBack')}</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2">
                <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-[#0F5C47] focus:ring-[#0F5C47]" />
                <span className="text-sm text-gray-600">Remember me</span>
              </label>
              <a href="#" className="text-sm text-[#0F5C47] hover:text-[#0d4a39]">
                {t('forgotPassword')}
              </a>
            </div>
