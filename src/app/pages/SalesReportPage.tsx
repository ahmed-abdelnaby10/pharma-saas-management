...
import { FileText, Calendar, Download, TrendingUp, DollarSign, ShoppingCart } from 'lucide-react';
...
export function SalesReportPage() {
  ...
  const salesData = [
    { id: 'week1', period: 'Week 1', medicines: 12500, cosmetics: 4200, total: 16700 },
    { id: 'week2', period: 'Week 2', medicines: 15200, cosmetics: 5800, total: 21000 },
    { id: 'week3', period: 'Week 3', medicines: 13800, cosmetics: 4900, total: 18700 },
    { id: 'week4', period: 'Week 4', medicines: 16500, cosmetics: 6200, total: 22700 },
  ];

  const topProducts = [
    { id: 1, name: 'Paracetamol 500mg', type: 'Medicine', sold: 450, revenue: 4500 },
    { id: 2, name: 'Vitamin D3', type: 'Medicine', sold: 320, revenue: 6400 },
    { id: 3, name: 'Moisturizer Cream', type: 'Cosmetic', sold: 280, revenue: 7000 },
    { id: 4, name: 'Antibiotic Syrup', type: 'Medicine', sold: 250, revenue: 7500 },
    { id: 5, name: 'Sunscreen SPF 50', type: 'Cosmetic', sold: 220, revenue: 7700 },
  ];
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-2xl font-semibold text-gray-900">{t('salesReport')}</h1>
          <p className="text-sm text-gray-600 mt-1">Detailed sales analytics and performance</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200">
          ...
          <p className="text-2xl font-semibold text-gray-900">${totalMedicineSales.toLocaleString()}</p>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200">
          ...
          <p className="text-2xl font-semibold text-gray-900">${totalCosmeticSales.toLocaleString()}</p>
        </div>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[600px]">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="text-left py-3 px-4 text-sm font-medium text-gray-600 whitespace-nowrap">#</th>
                <th className="text-left py-3 px-4 text-sm font-medium text-gray-600 whitespace-nowrap">Product Name</th>
            ...
            <tbody>
              {topProducts.map((product, index) => (
                <tr key={product.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4 text-sm text-gray-900 text-right">{product.sold}</td>
                  <td className="py-3 px-4 text-sm font-medium text-gray-900 text-right">${product.revenue.toLocaleString()}</td>
                </tr>
              ))}
            </tbody>
          </table>
