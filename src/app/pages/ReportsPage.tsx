...
import { FileText, TrendingUp, Package, Calendar, Download, ArrowRight } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Business analytics and insights</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-900">{t('salesReport')}</p>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-900">{t('profitReport')}</p>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-900">{t('stockReport')}</p>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-900">{t('expiryReport')}</p>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <LineChart data={salesData}>
            ...
            <YAxis stroke="#999" />
            <Tooltip />
            <Line type="monotone" dataKey="sales" stroke="#0F5C47" strokeWidth={2} />
