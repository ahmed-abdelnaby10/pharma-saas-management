...
import { Plus, Search, Filter, FileDown, Edit, Trash2, AlertCircle, Package } from 'lucide-react';
        ...
        <div className="bg-white rounded-lg p-4 border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-semibold text-gray-900 mt-1">{mockMedicines.length}</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-semibold text-gray-900 mt-1">
                ${mockMedicines.reduce((sum, m) => sum + (m.stock * m.purchasePrice), 0).toLocaleString()}
              </p>
            </div>
                ...
                return (
                  <tr key={medicine.id} className="border-b border-gray-100 hover:bg-gray-50">
                    <td className="py-3 px-4">
                      <div>
                        <p className="text-sm font-medium text-gray-900 whitespace-nowrap">{medicine.name}</p>
                        <p className="text-xs text-gray-500">{medicine.tradeName}</p>
                      </div>
                    </td>
                    <td className="py-3 px-4 text-sm text-gray-600 whitespace-nowrap">{medicine.scientificName}</td>
                    <td className="py-3 px-4 text-sm text-gray-600 font-mono whitespace-nowrap">{medicine.barcode}</td>
                    <td className="py-3 px-4 text-sm text-gray-600 whitespace-nowrap">{medicine.category}</td>
                    <td className="py-3 px-4 text-sm text-gray-600 font-mono whitespace-nowrap">{medicine.batch}</td>
                    <td className="py-3 px-4">
                    ...
                    <td className="py-3 px-4 text-sm text-gray-900 text-right font-medium whitespace-nowrap">{medicine.stock}</td>
                    <td className="py-3 px-4 text-sm text-gray-900 text-right whitespace-nowrap">${medicine.sellingPrice}</td>
                    <td className="py-3 px-4">
                    ...
                    <td className="py-3 px-4">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          onClick={() => navigate(`/app/medicines/edit/${medicine.id}`)}
