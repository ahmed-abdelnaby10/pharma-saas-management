...
const mockUsers = [
  { id: '1', name: 'Ahmed Al-Rashid', email: 'ahmed@pharmacy.com', phone: '+966 50 123 4567', role: 'Admin', branchId: 'all', branch: 'All Branches', status: 'Active' as const },
  { id: '2', name: 'Sarah Johnson', email: 'sarah@pharmacy.com', phone: '+966 50 234 5678', role: 'Pharmacist', branchId: '1', branch: 'Main Branch', status: 'Active' as const },
  { id: '3', name: 'Mohammed Ali', email: 'mohammed@pharmacy.com', phone: '+966 50 345 6789', role: 'Pharmacist', branchId: '2', branch: 'North Branch', status: 'Active' as const },
];
                ...
                <tr key={user.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-gray-900 whitespace-nowrap">{user.role}</span>
                    </div>
                  </td>
                  <td className="py-3 px-4 text-sm text-gray-600 whitespace-nowrap">{user.branch}</td>
                  <td className="py-3 px-4">
