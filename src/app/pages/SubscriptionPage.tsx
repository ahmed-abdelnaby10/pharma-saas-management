...
const plans = [
  {
    name: 'Basic',
    price: 99,
    features: ['1 Branch', 'Up to 5 Users', 'Basic Reports', 'Email Support', '1000 Products'],
  },
  {
    name: 'Professional',
    price: 249,
    features: ['3 Branches', 'Up to 15 Users', 'Advanced Reports', 'Priority Support', 'Unlimited Products', 'Multi-branch Transfers', 'Representative Orders'],
    popular: true,
  },
  {
    name: 'Enterprise',
    price: 499,
    features: ['Unlimited Branches', 'Unlimited Users', 'Custom Reports', '24/7 Support', 'Unlimited Products', 'API Access', 'Custom Integrations', 'Dedicated Account Manager'],
  },
];
...
export function SubscriptionPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-gray-900">{t('subscription')}</h1>
      ...
      <div className="bg-gradient-to-r from-[#0F5C47] to-[#1a8c6b] rounded-xl p-6 text-white">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold mb-1">{tenant?.plan === 'professional' ? 'Professional' : tenant?.plan}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {plans.map((plan) => (
            ...
            >
              ...
              >
                {plan.popular ? 'Current Plan' : plan.name === 'Enterprise' ? 'Contact Sales' : t('upgradePlan')}
              </button>
            </div>
          ))}
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <div className="p-6 pb-0">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">{t('billingHistory')}</h3>
        </div>
          ...
          <table className="w-full min-w-[600px]">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="text-left py-3 px-4 text-sm font-medium text-gray-600 whitespace-nowrap">Description</th>
                ...
                <th className="text-right py-3 px-4 text-sm font-medium text-gray-600 whitespace-nowrap">Invoice</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-gray-100">
                <td className="py-3 px-4 text-sm text-gray-600 whitespace-nowrap">Mar 9, 2026</td>
                <td className="py-3 px-4 text-sm text-gray-900">Professional Plan - Monthly</td>
                <td className="py-3 px-4 text-sm text-gray-900 text-right whitespace-nowrap">$249.00</td>
                ...
                <td className="py-3 px-4 text-right">
                  <button className="text-sm text-[#0F5C47] hover:text-[#0d4a39] font-medium whitespace-nowrap">Download</button>
                </td>
              </tr>
            </tbody>
          </table>
