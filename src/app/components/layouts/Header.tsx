          ...
          <DropdownMenu.Trigger className="flex items-center gap-2 px-2 md:px-3 py-2 rounded-lg hover:bg-gray-100 transition-colors">
            <div className="flex items-center gap-2">
              ...
              <div className={direction === 'rtl' ? 'text-right' : 'text-left'}>
                <div className="text-sm font-medium hidden sm:block">{currentBranch?.name}</div>
                <div className="text-xs text-gray-500 hidden md:block">{tenant?.name}</div>
              </div>
            </div>
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <DropdownMenu.Root>
          ...
          <DropdownMenu.Portal>
            ...
            >
              ...
              >
                <span className="text-sm">Ã˜Â§Ã™â€žÃ˜Â¹Ã˜Â±Ã˜Â¨Ã™Å Ã˜Â©</span>
              </DropdownMenu.Item>
            </DropdownMenu.Content>
          </DropdownMenu.Portal>
        </DropdownMenu.Root>
        ...
        <DropdownMenu.Root>
          <DropdownMenu.Trigger className="flex items-center gap-2 px-2 md:px-3 py-2 rounded-lg hover:bg-gray-100 transition-colors">
            ...
            <div className={`${direction === 'rtl' ? 'text-right' : 'text-left'} hidden md:block`}>
